  ...
  return (
    ...
    >
      <section>
        <h2>Projects</h2>
        <p>
          Here some projects primarily built with vanilla{" "}
          <strong>JavaScript</strong>, <strong>CSS</strong>,{" "}
          <strong>HTML5</strong>, and <strong>ReactJS</strong>.
        </p>
        <p>
          Of course, in the development of these applications I use additional
          tools such as <strong>Git</strong>, databases such as
          <strong>MongoDB</strong>, state management libraries such as{" "}
          <strong>Redux</strong> and testing frameworks such as{" "}
          <strong>Jest</strong>, among others.
        </p>
      </section>
          ...
          return (
            <ul key={proj.id} className="card-container">
              ...
              <a
                ...
                aria-label={`Visit ${proj.name} project`}
              >
                <motion.h3
